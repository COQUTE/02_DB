...
SELECT SYSDATE -1 "하루 전", SYSDATE 현재시간,
SYSDATE + 1 AS "내일"
FROM DUAL;
...
-- CTRL + SHIFT + 위 아래 방향키 : 줄 위 아래 이동
-- CTRL + ALT + 위 아래 방향키 : 줄 위 아래 복사
