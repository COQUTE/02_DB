...
-- DEFAULT 설정된 컬럼이라고 삽입/수정 시 DEFAULT만 작성해야 하는 것 아닙!
-- 컬럼 데이터타입에 맞춘 데이터 삽입/수정 가능

SELECT * FROM MEMBER;

-- 가입일 -> INSERT 시 미작성 하는 경우 DEFAULT 값이 반영되는지 확인
-- INSERT INTO INTO 테이블명 (컬럼명1, 컬럼명2) VALUES(값1, 값2);
...
CREATE TABLE USER_USED_PK (
	...
	EMAIL VARCHAR2(50)
	-- 테이블레벨
	--, CONSTRANT USER_NO_PK PRIMARY KEY(USER_NO)
);
