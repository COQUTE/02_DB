...
VALUES('900', '홍길동', '980725-1234567', 'hong_gd@or.kr',
...
-- 선택 안 된 컬럼은 값이 NULL이 들어감 (DEFAULT 존재 시 DEFAULT 설정한 값이 삽입됨)

INSERT INTO EMPLOYEE2 (EMP_ID, EMP_NAME, EMP_NO, EMAIL, PHONE,
	DEPT_CODE, JOB_CODE, SAL_LEVEL, SALARY)
VALUES ('900', '홍길동', '980725-1234567', 'hong_gd@or.kr', '01011112222', 
	'D1', 'J7', 'S3', 4300000);
...
SELECT * FROM EMPLOYEE2
WHERE EMP_ID = '900';
-- 조회 다시해봄(영구저장 되었기 때문에 롤백해도 되돌리기 안 됨)
...
-- 서브쿼리(SELECT) 결과를 EMP_01 테이블 INSERT
...
-- DEPARTMENT2 테이블에서 DEPT_ID가 'D9'인 부서의 정보 조회
SELECT * FROM DEPARTMENT2
WHERE DEPT_ID = 'D9';
...
INSERT INTO EMP_M02
VALUES(999, '곽두팔', '561016-1234567', 'kwack_dw@or.kr',
